            ...
            <div className="desktop-separation lg:pr-14">
              ...
              <div className="reverse flex flex-col-reverse md:flex-col">
                ...
                <div className="socials flex justify-center py-6 md:justify-start lg:pt-20 lg:pb-0">
                  <FacebookIcon className="cursor-pointer mr-2 md:mr-3" />
                  <YoutubeIcon className="cursor-pointer mr-2 md:mr-3" />
                  <TwitterIcon className="cursor-pointer mr-2 md:mr-3" />
                  <PinterestIcon className="cursor-pointer mr-2 md:mr-3" />
