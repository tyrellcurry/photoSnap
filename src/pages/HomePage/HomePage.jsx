    ...
    <>
      <section className="section-1 md:flex ">
        <img
          ...
          className="md:order-2 md:hidden"
        />
        <img
          src="../../assets/home/tablet/create-and-share.jpg"
          alt="Man standing on pier"
          className="md:order-2 hidden md:block lg:hidden"
        />
        <img
          src="../../assets/home/desktop/create-and-share.jpg"
          alt="Man standing on pier"
          className="md:order-2 hidden md:hidden lg:block"
        />
        <div className="section-paragraph py-20 px-12 bg-black text-pureWhite md:order-1 md:py-44 lg:px-24">
          <h1 className="text-3xl tracking-wide uppercase text-left font-bold md:text-[2.5rem] md:tracking-[0.260625rem] md:leading-10">
            Create and Share your Photo Stories.
          </h1>
          <p className="text-base font-normal opacity-60 leading-6 mt-4 lg:mt-6">
      ...
      <section className="section-2 md:flex ">
        ...
        <div className="section-paragraph py-20 px-12 md:py-44 lg:px-24">
          <h1 className=" text-3xl uppercase tracking-wide  text-left font-bold md:text-[2.5rem] md:tracking-[0.260625rem] md:leading-10">
            Beautiful Stories Every Time
          </h1>
          <p className="text-base opacity-60 leading-6 mt-4 lg:mt-6">
