  ...
  return (
    <>
      <section className='section-1 md:flex '>
        ...
        <img src="../../assets/home/desktop/create-and-share.jpg" alt="Man standing on pier" className='md:order-2 hidden md:hidden lg:block' />
      ...
      <section className='section-2 md:flex '>
        ...
        <img src="../../assets/home/desktop/beautiful-stories.jpg" alt="Laptop On Desk" className=' hidden md:hidden lg:block' />
      ...
      <section className='section-3 md:flex '>
        ...
        <img src="../../assets/home/desktop/designed-for-everyone.jpg" alt="Man standing on pier" className='md:order-2 hidden md:hidden lg:block' />
