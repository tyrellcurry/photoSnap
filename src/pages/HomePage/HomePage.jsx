  ...
  return (
    <>
      <section className='section-1 md:flex '>
        <img src="../../assets/home/mobile/create-and-share.jpg" alt="Man standing on pier" className='md:order-2 md:hidden w-full' />
        <img src="../../assets/home/tablet/create-and-share.jpg" alt="Man standing on pier" className='md:order-2 hidden md:block lg:hidden w-full' />
        <img src="../../assets/home/desktop/create-and-share.jpg" alt="Man standing on pier" className='md:order-2 hidden md:hidden lg:block w-full' />
      ...
      <section className='section-2 md:flex '>
        <img src="../../assets/home/mobile/beautiful-stories.jpg" alt="Laptop On Desk" className='md:hidden w-full' />
      ...
      <section className='section-3 md:flex '>
        <img src="../../assets/home/mobile/designed-for-everyone.jpg" alt="Man standing on pier" className='md:order-2 md:hidden w-full' />
